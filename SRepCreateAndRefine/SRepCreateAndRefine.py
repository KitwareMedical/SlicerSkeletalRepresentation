...
class SRepCreateAndRefine(ScriptedLoadableModule):
    ...
    def __init__(self, parent):
        ...
        self.parent.contributors = ["Connor Bowley (Kitware, Inc)", "PipelineCreator"]
...
class SRepCreateAndRefineInputs:
    ...
    createEllipticalNumFoldPoints: int
    createEllipticalNumStepsToCrest: int
    createEllipticalDt: float
    createEllipticalSmoothAmount: float
    createEllipticalMaxIterations: int
    refinementInterpolationLevel: int
    refinementInitialRegionSize: float
    refinementFinalRegionSize: float
    refinementMaxIterations: int
    refinementImageMatchWeight: float
    refinementNormalMatchWeight: float
    refinementGeometricIllegalityWeight: float
