                                                                  ...
                                                                  double lambda, vtkSpoke *interpolatedSpoke)
{
    ...
    vtkNew<vtkSpoke> topMiddle, leftMiddle, rightMiddle, botMiddle;
    ...
    vtkNew<vtkSpoke> centerA, centerB, center;
...
void vtkSlicerSkeletalRepresentationInterpolater::InterpolateSkeletalPoint(vtkSpoke **cornerSpokes,double u, double v, double *output)
{
    vtkSpoke* Sp11 = cornerSpokes[0];
    vtkSpoke* Sp21 = cornerSpokes[1];
    vtkSpoke* Sp22 = cornerSpokes[2];
...
void vtkSlicerSkeletalRepresentationInterpolater::SetCornerDxdu(double *u11, double *u21, double *u22, double *u12)
{
...
void vtkSlicerSkeletalRepresentationInterpolater::SetCornerDxdv(double *v11, double *v21, double *v22, double *v12)
{
