...
GradientDistanceFilter::GradientDistanceFilter()
{

}

bool GradientDistanceFilter::CompareImages(VectorImage::Pointer input, VectorImage::Pointer output)
{
...
void GradientDistanceFilter::Filter(RealImage::Pointer input, VectorImage::Pointer output)
{
...
void GradientDistanceFilter::DeepCopy(VectorImage::Pointer input, VectorImage::Pointer output)
{
    VectorImage::RegionType region = input->GetLargestPossibleRegion();
