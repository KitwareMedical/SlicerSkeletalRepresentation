...
class sAJIVE(object):
    ...
    def __init__(self,
                 ...
                 store_full=True, n_jobs=None, labels=None):
        self.y = labels
    ...
    def compute_affinity_matrix(self, dist):
        n, n = dist.shape
        affinity = np.eye(n)
        v_w = 5
        v_b = 5
        ...
        return affinity
    def fit(self, blocks, precomp_init_svd=None, target=None):
        """
        ...
        for bn in block_names:
            ...
            aff_mat = self.compute_affinity_matrix(data @ data.T)
            blocks[bn] = aff_mat @ blocks[bn]
